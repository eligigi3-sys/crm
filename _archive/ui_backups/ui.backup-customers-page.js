...
function openCustomerCard(id) {
  ...
  apiCall('GET', '/api/contacts/' + id).then(function(data) {
    ...
    html += '</div>';
    html += '<div id="customer-event-details"></div>';
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var newCustomerBtn = document.getElementById("btn-new-customer"); if (newCustomerBtn) newCustomerBtn.addEventListener("click", openLeadModal);\n  if (custSearch) custSearch.addEventListener('input', function() {
